...
@app.callback(
    Output('solo-single-line-graph', 'children'),
    [Input('solo-single-players', 'value'),
     Input('solo-single-interval', 'n_intervals')]
)
...
@app.callback(
    Output('solo-multi-line-plot', 'children'),
    [Input('solo-multi-interval', 'n_intervals')]
)
def show_graph(none):
